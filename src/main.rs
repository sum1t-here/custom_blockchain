...
fn main() {
    ...
    blockchain.mining();
    blockchain.print();
    println!("A: {:?}\n", blockchain.calculate_total_amt(wallet_a.get_address()));
    println!("B: {:?}\n", blockchain.calculate_total_amt(wallet_b.get_address()));
    println!("Miner: {:?}\n", blockchain.calculate_total_amt(wallet_miner.get_address()));
}
